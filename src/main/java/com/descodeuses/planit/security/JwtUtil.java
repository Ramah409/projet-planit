...
public class JwtUtil {
    ...
    public String extractUsername(String token) { //verifie à qui appartient 
    ...
    private boolean isTokenExpired(String token) {
        ...
        return expiration.before(new Date()); // .before = Retourne true si la date d'expiration est dépassée
    }
}
